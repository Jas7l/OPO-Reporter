...
class ScheduleBaseService:
    ...
    def create_schedule(self) -> Dict[str, Any]:
        ...
        try:
            status_enum = EmployeeStatusCode(status) if status else EmployeeStatusCode.WORK
        except ValueError:
        ...
        with self._pg.begin():
            ...
            if existing:
                raise ModuleException('Schedule already exists for this date',
                                      {'employee_id': employee_id, 'date': date_val}, 409)
